...
public final class Intents {
	...
	public static final class Scan {
		 ...
		 * available. Call intent.getIntExtra(RESULT_ORIENTATION).
		 */
		 ...
		 * if available. Call
		 * intent.getStringExtra(RESULT_ERROR_CORRECTION_LEVEL).
		 */
		 ...
		 * segment is under key "SCAN_RESULT_BYTE_SEGMENTS_0" for example.
		 */
